document.addEventListener('DOMContentLoaded', () => {
    ...
    const calculateResults = (event) => {
        ...
        const onesValue = onesInput.value ? parseFloat(onesInput.value) * 1.1 / 8 : 0;
        const twosValue = twosInput.value ? parseFloat(twosInput.value) * 1.5 / 8 : 0;
        const threesValue = threesInput.value ? parseFloat(threesInput.value) * 2.0 / 8 : 0;
